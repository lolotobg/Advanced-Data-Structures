 ...
 * @author Dimitar
 */
public class AuthorHashMapTest {

    public AuthorHashMapTest() {
    }
    ...
    private void testAutomaticResizing(HashMap<Integer> hmap, Map<String, Integer> tmap, int minCap, int maxCap) {
        ...
        for (Map.Entry<String, Integer> it : tmap.entrySet()) {
            ...
            assertTrue(it.getValue().equals(hmap.get(it.getKey())));
        }
    }
    ...
    public void simpleTest1() {
        // Default constructor
        HashMap<Integer> hmap1 = new HashMap<Integer>();
        Map<String, Integer> tmap1 = new java.util.HashMap<String, Integer>();
    ...
    public void simpleTest2() {
        ...
        HashMap<Integer> hmap2 = new HashMap<Integer>(1337);
        Map<String, Integer> tmap2 = new java.util.HashMap<String, Integer>();
    ...
    public void simpleTest3() {
        ...
        HashMap<Integer> hmap3 = new HashMap<Integer>(1337, 42000);
        Map<String, Integer> tmap3 = new java.util.HashMap<String, Integer>();
